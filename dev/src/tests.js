...
function loadTestData(){
	...
	$("#pdf_job1_emp_desc").html("The eBay of New Zealand, handling half of New Zealand's daily internet traffic, and an NZX Top 50 company.");
	...
	$("#job_4_time").html("September 2016 - January 2016 (fixed term contract)");
	...
	user_skills="Team Leadership, Customer Service, Web Architecture & Development, Server & System Management, Data & Analytics, Microsoft Office, Stakeholder Management, Agile experience"
